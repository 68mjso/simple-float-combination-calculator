...
def ieee_754_conversion(m, sgn_len=1, exp_len=8, mant_len=23):
    n = struct.unpack("I", struct.pack("f", m))[0]
    """
...
if __name__ == "__main__":
    print("Manually converted:", ieee_754_conversion(0.6666666, exp_len=8, mant_len=23))
